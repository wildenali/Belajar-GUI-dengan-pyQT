...
class MainForm(QWidget):
    ...
    def setupUI(self):
        self.resize(400,200)
        self.move(300,300)
        self.setWindowTitle('QLabel, QLineEdit, QPushButton')
        ...
        self.subsctractButton.clicked.connect(self.subsctractButtonClick)
    ...
    def subsctractButtonClick(self):
        self.calculate('-')
